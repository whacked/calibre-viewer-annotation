...
*** Manning epubs
    ...
    it turns out the example book here, Fogus's /The Joy of Clojure/, as a bunch of calibre markup in it: looks like Manning is running a calibre converter in the backend?
